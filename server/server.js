	...
	if (err) {
		...
		.then(function () {
			...
			if (process.env.NODE_ENV === 'development') {
				...
				return Promise.all([user1Prom, user2Prom, coord1Prom, coord2Prom, question1Prom, question2Prom, resp1Prom])
				.spread((user1, user2, coord1, coord2, question1, question2, resp1) => {
					...
					.then(() => console.log("Dummy data successfully added."));
				})
			}
			// =====================
		}, (err) => {
